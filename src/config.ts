...
export const config = {
  ...
  /** Postlarga AI rasm generatsiya qilinsinmi (standart). Chatda /rasm bilan o'zgartiriladi. */
  ...
  /** Kanal mavzusi — noldan original post yozishda agentga beriladi. */
   ...
   * Masalan "rss,rss,original,rss,rss,project" => har 6 postda 4 RSS, 1 original, 1 loyiha.
   */
  ...
  /** Standart post jadvali (Toshkent vaqti, HH:MM). Chatdan o'zgartiriladi. */
  scheduleDefault: optional("SCHEDULE", "10:00,19:00"),
  /** Admin-botga buyruq bera oladigan Telegram ID'lar. */
